...
#include "Mikromedia_HMI_70C_Demo_resources.h"
...
int temp_t[4]={417,417,417,417},hum_t[4]={417,417,417,417},dim_l[4]={417,417,417,417},hum_l[4]={417,417,417,417};
...
void Home_Change() {
    ...
    if(k==1) {
        ...
        case 2:
            ...
            break;
        case 3:
            Label12.Font_Color=0x0000FFFF;
            Label13.Font_Color=0x0000FFFF;
            Box17.Color=0x00400080;
            Box18.Color=0x00400080;
            Image18.Visible=0;
            Image19.Visible=0;
            Image32.Visible=1;
            Image33.Visible=1;
            ...
            break;
        case 4:
            Label14.Font_Color=0x0000FFFF;
            Box19.Color=0x00400080;
            Image20.Visible=0;
            Image34.Visible=1;
            if(hom==1) DrawScreen(&Home);
            break;
        ...
        case 6:
            ...
            break;
        case 7:
            Box4.Color=0x00C0C0C0;
            Label37.Font_Color=0x00000000;
            Image11.Visible=0;
            Image22.Visible=1;            
            if(hom==1) DrawScreen(&Home);
            break;
        case 8:
            ...
            break;
        case 9:
            Box6.Color=0x00C0C0C0;
            Label39.Font_Color=0x00000000;
            Image13.Visible=0;
            Image24.Visible=1;            
            if(hom==1) DrawScreen(&Home);
            break;
        case 10:
            ...
            break;
        case 11:
            Box8.Color=0x00C0C0C0;
            Label41.Font_Color=0x00000000;
            Image15.Visible=0;
            Image26.Visible=1;            
            if(hom==1) DrawScreen(&Home);
            break;
        ...
        default:
            ...
            Label12.Font_Color=0x00FFFFFF;
            Label13.Font_Color=0x00FFFFFF;
            Label14.Font_Color=0x00FFFFFF;
            Label36.Font_Color=0x00FFFFFF;
            Label37.Font_Color=0x00FFFFFF;
            Label38.Font_Color=0x00FFFFFF;
            Label39.Font_Color=0x00FFFFFF;
            Label40.Font_Color=0x00FFFFFF;
            Label41.Font_Color=0x00FFFFFF;                                                           
            Box3.Color=0x00808080;
            Box4.Color=0x00808080;
            Box5.Color=0x00808080;
            Box6.Color=0x00808080;
            Box7.Color=0x00808080;
            Box8.Color=0x00808080;
            Box12.Color=0x00808080;
            Box13.Color=0x008000FF;
            Box14.Color=0x008000FF;
            Box15.Color=0x008000FF;
            Box16.Color=0x008000FF;
            Box17.Color=0x008000FF;
            Box18.Color=0x008000FF;
            Box19.Color=0x008000FF;
...
void Green_power_bars() {
    if(gr_pow==1) {
        if(Box71.Top>=412) {
            ...
            Box71.Top+=1;
            Box71.Height-=1;
            ha=12-(int)floor((Box71.Top-72)*12/344);
        ...
        if(Box72.Top>=412) {
            ...
            so=100-(int)floor((Box72.Top-72)*100/344);
            if(so>100) so-=100;
            IntToStr(so,tekst_1);
            strcpy(Label99.Caption,tekst_1);
        }
        if(Box73.Top>=412) {
            ...
            ba=100-(int)floor((Box73.Top-72)*100/344);
            if(ba>100) ba-=100;
            IntToStr(ba,tekst_2);
            strcpy(Label100.Caption,tekst_2);
        }
...
void Button12OnClick() {
    strcpy(Label21.Caption,Label99.Caption);
    strcat(Label21.Caption,"%");
    strcpy(Label22.Caption,Label100.Caption);
    strcat(Label22.Caption,"%");
...
void CircleButton1OnPress() {
    ...
    t_t[choice_t]=15+(int)floor((Box23.Left-417)*15/260);
...
void CircleButton2OnPress() {
    ...
    h_t[choice_t]=20+(int)floor((Box49.Left-417)*60/260);
...
void CircleButton5OnPress() {
    ...
    d_l[choice_t]=0+(int)floor((Box64.Left-417)*100/260);
...
void CircleButton6OnPress() {
    ...
    h_l[choice_t]=15+(int)floor((Box65.Left-417)*15/260);

#ifndef MIKROMEDIA_HMI_35C_DEMO_OBJECTS
#define MIKROMEDIA_HMI_35C_DEMO_OBJECTS
...
extern TLabel *const code Home_Labels[31];
extern TImage *const code Home_Images[36];

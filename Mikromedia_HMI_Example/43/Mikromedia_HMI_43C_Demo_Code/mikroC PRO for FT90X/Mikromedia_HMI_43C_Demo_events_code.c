...
int temp_t[4]={219,219,219,219},hum_t[4]={219,219,219,219},dim_l[4]={219,219,219,219},hum_l[4]={219,219,219,219};
...
void Green_power_bars() {
    if(gr_pow==1) {
        if(Box71.Top>=230) {
            ...
            Box71.Top+=1;
            Box71.Height-=1;
            ha=12-(int)floor((Box71.Top-40)*12/192);
        ...
        if(Box72.Top>=230) {
            ...
            so=100-(int)floor((Box72.Top-40)*100/192);
            IntToStr(so,tekst_1);
            strcpy(Label99.Caption,tekst_1);
        }
        if(Box73.Top>=230) {
            ...
            ba=100-(int)floor((Box73.Top-40)*100/192);
            IntToStr(ba,tekst_2);
            strcpy(Label100.Caption,tekst_2);
        }
